...
if __name__ == '__main__':
    api = RequestApi(appid="5d41a96a", secret_key="1821d9baf6453bd0553e067defc0088a", upload_file_path=r"E:\裏\图\OneDrive - Office.Inc\Q-learning\高端论坛第三十六期：心流的秘密——数字娱乐的幸福心理探索\高端论坛第三十六期：心流的秘密——数字娱乐的幸福心理探索_6.mp3")
    asr_result = api.all_api_request()
    for i in eval(asr_result['data']):
        print(i)